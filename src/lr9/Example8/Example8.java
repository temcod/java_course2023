...
class Node {
    ...
    protected void createHead(int[] values) { //– ввод с головы createHead();
        ...
        this.head = head;
        System.out.println("Формирование односвязного списка c головы:");
    }
    ...
    protected void createTail(int[] values) {//– ввод с хвоста createTail();
        ...
        this.head = head;
        System.out.println("Формирование односвязного списка c хвоста:");
    }
    ...
    protected void RemoveLast() {// – удаление последнего элемента списка RemoveLast();
        ...
        ref.next = null;
        System.out.println("Удаление элемента с хвоста списка:");
    }
    ...
    Node createHeadRec(int value) { // – ввод с головы createHeadRec();
        if (value == 0) {
            System.out.println("Формирование односвязного списка с головы при помощи рекурсии:");
            return null;
        }
    ...
    int createTailRec(int value){ // – ввод с хвоста createTailRec();
        if (value ==0) {
            System.out.println("Формирование односвязного списка с хвоста при помощи рекурсии:");
            Node head = null;
            this.head = null;
            return 0;
        }
    ...
    public String toStringRec(Node head) {// вывод (возвращается строка, сформированная из элементов списка) toString();
        if (head == null) {
            return " Печать односвязного списка при помощи рекурсии:";
        }
